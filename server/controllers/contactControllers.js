...
const getContactPageData = async (req, res) => {
  try {
    ...
    return res.status(200).json({
      ...
      data: {
        contactInfo: {
          companyName: contactInfo.site_name || "ElectroLab Technologies",
          address: contactInfo.company_address || "123, Maker Street, Koramangala, Bengaluru, Karnataka 560034, India",
          phone: contactInfo.support_phone || "+91 98765 43210",
          email: contactInfo.support_email || "support@electrolab.in",
          whatsapp: contactInfo.whatsapp_number || "+919876543210",
          whatsappUrl: `https://wa.me/${(contactInfo.whatsapp_number || "+919876543210").replace(/[^0-9]/g, "")}?text=Hi%20ElectroLab%20Support!`,
